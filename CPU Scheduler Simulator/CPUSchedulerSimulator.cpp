...
void displayQueue(queue<Process> &m) {
    ...
    while (!t.empty()) {
        cout << t.front().name << "," << t.front().exeTime << " " << endl;
        t.pop();
    }
}
